...
resource "aws_internet_gateway" "dcos_default_gateway" {
  vpc_id = "${aws_vpc.default.id}"
}

# Grant the VPC internet access on its main route table
resource "aws_route" "dcos_internet_access" {
...
resource "aws_subnet" "dcos_public" {
  vpc_id                  = "${aws_vpc.default.id}"
...
resource "aws_subnet" "dcos_private" {
  vpc_id                  = "${aws_vpc.default.id}"
...
resource "aws_security_group" "dcos_private_slave" {
